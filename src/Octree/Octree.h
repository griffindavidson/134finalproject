...
#pragma once
#include "ofMain.h"
#include "Dependencies/box.h"
#include "Dependencies/ray.h"
...
public:
    ...
    void collectLeafBoxes(TreeNode &node, vector<Box> &leafBoxes);
    
    vector<ofColor> colors = {ofColor::red, ofColor::orange, ofColor::yellow, ofColor::green, ofColor::blue, ofColor:: purple, ofColor::pink};
